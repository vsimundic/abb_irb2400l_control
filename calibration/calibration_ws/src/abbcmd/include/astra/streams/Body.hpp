...
namespace astra {
    ...
    */
    ...
    public:
        ...
        {
            return (::astra_body_t::features & ASTRA_BODY_FEATURES_JOINTS) != ASTRA_BODY_FEATURES_NONE;
        }

        bool hand_poses_enabled() const
        {
            return (::astra_body_t::features & ASTRA_BODY_FEATURES_HANDPOSES) != ASTRA_BODY_FEATURES_NONE;
        }
